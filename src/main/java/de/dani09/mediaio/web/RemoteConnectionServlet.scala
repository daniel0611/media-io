...
import de.dani09.mediaio.config.{Config, DownloadedMovies}
import de.dani09.mediaio.data.Movie
import de.dani09.mediaio.web.DownloadStatus._
import de.dani09.mediaio.web.RemoteConnectionServlet._
